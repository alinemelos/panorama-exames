...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        ...
        {'name': 'Plantões', 'description': 'Abertura, acompanhamento e fechamento de plantões'},
        {'name': 'Dashboard', 'description': 'Indicadores e relatórios consolidados'},
    ],
}
